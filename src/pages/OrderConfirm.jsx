...
export function OrderConfirm() {
  ...
  if (!stagedOrder && !isConfirmed) return <div className='main-layout'>No staged order found!</div>
  if (!stagedOrder.stay) return <div className='main-layout'>No stay found!</div>
      ...
      <div className='order-confirm-container'>
        ...
        <div className='order-confirm-body'>
          ...
          <div className='order-confirm-summary'>
            <div className='summary-header flex'>
              <div className='rare-find flex'>
                <div className='rare-find-title'>
                  ...
                  <h5 className='rare-find-subtitle'>This place is usually booked.</h5>
                </div>
              ...
              <div className='summary-details'>
                ...
                <div className='summary-details-guests'>
                  ...
                  <h5 className='summary-details-subtitle'>
                    {stagedOrder.guests.adults} adults, {stagedOrder.guests.children} children
                  </h5>
                </div>
              </div>
            </div>
            ...
            {!isConfirmed && (
              <section className='summary-body'>
                <article className='summary-body-cancel'>
                  <div className='summary-body-cancel-title'>Cancellation policy</div>
                  Cancel before 12:00 PM on Nov 1 for a partial refund. After that, your refund
                  depends on when you cancel. Learn more
                </article>
                <div className='divider'></div>
                <article className='summary-body-cancel flex'>
                  ...
                  <div className='cancel-title'>
                    Your reservation won’t be confirmed until the Host accepts your request (within
                    24 hours).
                ...
                <article className='summary-body-agreement'>
                  <div className='agreement-header'>
                    ...
                    <span> Host's House Rules</span>,<span> Ground rules for guests</span>,
                    <span> Airbnb's Rebooking and Refund Policy</span>, and that Airbnb can
                    <span> charge my payment method </span>
                    if I’m responsible for damage. I agree to pay the total amount shown if the Host
                    accepts my booking request.
                  </div>
                  <div className='agreement-body'>
                    I also agree to the
                    <span> updated</span>
                    <span> Terms of Service</span>,<span> Payments Terms of Service</span>, and I
                    acknowledge the
            ...
            >
              {!isConfirmed && loggedUser && <BrandedBtn txt='Request to book' width={'175px'} />}
              {isConfirmed && (
                <Link to='/order'>
