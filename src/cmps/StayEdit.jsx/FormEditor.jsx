    ...
    <section className="stay-edit main-layout">
        ...
        <form onSubmit={handleSubmit} className="stay-edit-form">
            ...
            <div className="property-type">
              ...
              >
                <div className="property-type-text">
                  ...
                  <span className="subtitle">
                    Guests have their own private room for sleeping. Other areas
                    could be shared.
                  </span>
                </div>
                <div className="property-type-icon">
          ...
          <section className={`step-8 ${pageIdx === 7 ? "selected" : ""}`}>
            <div className="text">
              ...
              <span className="subtitle">
                Guests are more likely to book a listing that includes photos.
                You can add more photos after you publish your listing.
              </span>
            </div>
            <ImagesEditor
              urls={imgUrls}
          ...
          <section className={`step-12 ${pageIdx === 11 ? "selected" : ""}`}>
            ...
            <div className="price-input">
              <span
                className="price-sign"
                style={{ color: price > 0 ? "#222222" : "#717171" }}
              >
                $
              </span>
              <input
      ...
      <footer className="stay-edit-footer">
        <div
          ...
          style={
            pageIdx === pages.length - 1 ? { height: "2px" } : { height: "8px" }
          }
        >
          <div
            className="loader"
