      ...
      <main className='stay-details-main'>
        <div className='stay-details-preview'>
          ...
          <div className='stay-details-rating'>
            <AiFillStar />
            <span className='avg-rate'>{avgRate}</span> ·<a href='#reviews'>{reviews.length} Reviews</a>
          </div>
        </div>
        ...
        <div className='stay-details-host'>
          <div className='host-info'>
            <div className='host-img'>
              {host.imgUrl ? <img src={host.imgUrl} alt='' /> : <img src='https://i.ibb.co/jDy9rL4/user.png' alt='userImg' />}
            </div>
        ...
        <div className='stay-details-description'>
          <div className='description-text'>
            {/* <p>{summary}</p> */}
            <p>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit consequuntur aliquid ratione iusto eius, rem dolores
              in optio unde libero aliquam possimus, alias quos reiciendis repudiandae ipsam expedita eos! Rerum, suscipit. Quasi ex libero
              dolorem neque vel provident assumenda voluptatibus debitis, aperiam tenetur, maiores laudantium porro rem cum amet. Ipsam!
            </p>
          </div>
        </div>
