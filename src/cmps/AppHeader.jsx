  ...
  return (
    <React.Fragment>
      {!(isMobile && isStayPage) ? (
        <React.Fragment>
          <section
            className={`header-container main-layout ${isStayPage ? 'stayDetails relative' : ''}
      ...
      {!(isMobile && isExploreExpanded) ? (
        // <div className={isStayPage ? "divider unset" : "divider"}></div>
        <div
          className={`divider ${isStayPage ? 'unset' : ''} ${isExploreExpanded ? 'expanded' : ''}`}
