...
function handleExpandChange(value) {
  ...
  return (
    ...
    main-layout ${isStayPage ? "stayDetails relative" : ""} ${
            isOrderPage ? "medium relative" : ""
          }
          `}
          // style={isExpanded ? { height: "160px", position:"fixed", borderBlockEnd: "1px solid #ebebeb", width: "100%", zIndex: "1000", backgroundColor: "white" } : {position:"sticky", top: "0", zIndex: "1000"}}
        >
          {!isMobile && (
