      ...
      <header className={`main-header flex`}>
        <div className="logo flex">
          ...
          <svg
            ...
            height="17"
            viewBox="0 0 63 17"
            className="l9wcq5l atm_9s_glywfm atm_9s_1o8liyq__oggzyc dir dir-ltr"
          >
        ...
        <div>
          ...
          <div
            className={`explore-bar ${isExpanded ? "expanded" : ""}`}
        ...
        {/* <div className="explore-bar" style={{ display: isExpanded ? "flex" : "none" }}>
          <ExploreBy />
        </div> */}
      </header>
    </section>
