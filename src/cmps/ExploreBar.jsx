              ...
              >
                <div className="check-out-text flex">
                  ...
                  <input
                    ...
                    placeholder={
                      selectedRange.to
                        ? utilService.getDateString(selectedRange.to)
                        : "Add dates"
                    }
                    readOnly
                    value={
              ...
              <React.Fragment>
                ...
                <div className="ebm-modal-container">
                  {!whereCollapsed ? (
                    ...
                    <div
                      className="where-container collapsed"
                      onClick={handleCollapse("where")}
                    >
                  ...
                  {!whenCollapsed ? (
                    ...
                    <div
                      className="when-container collapsed"
                      onClick={handleCollapse("when")}
                    >
                  ...
                  {!guestsCollapsed ? (
                    ...
                    <div
                      className="guests-container collapsed"
                      onClick={handleCollapse("guests")}
                    >
                      <div className="guests-title">
                        <span>Guests</span>
                  ...
                  <div
                    ...
                    style={
                      mobileExploreBar ? { bottom: "0px" } : { bottom: "-80px" }
                    }
                  >
                    <button
