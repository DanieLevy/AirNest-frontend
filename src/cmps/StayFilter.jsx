...
export function StayFilter() {
  ...
  const filterModal = useSelector((storeState) => storeState.userModule.filterModal)
  const [inputBoxShadow1, setInputBoxShadow1] = useState('rgb(228, 228, 228) 0px 0.5px 1px 0px')
  ...
  function handleSubmit(ev) {
    ...
    if (selectedProperties) searchParams.set(QUERY_KEYS.properties, selectedProperties)
