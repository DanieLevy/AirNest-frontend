...
export function StayFilter() {
  ...
  const [inputBoxShadow1, setInputBoxShadow1] = useState('inset 0 0 0 1px #b0b0b0')
  const [inputBoxShadow2, setInputBoxShadow2] = useState('inset 0 0 0 1px #b0b0b0')
  ...
  useEffect(() => {
    ...
    showResultLength()
  }, [minPrice, maxPrice, selectedBedrooms, selectedBeds, selectedBathrooms, selectedAmmenties])
            ...
            <div className='filter-modal-body'>
              <div className='price-range'>
                ...
                <div className='price-range-inputs'>
                  <div className='price-range-input' style={{ boxShadow: inputBoxShadow1 }}>
                  ...
                  <div className='price-range-input' style={{ boxShadow: inputBoxShadow2 }}>
                  ...
                  {['Any', '1', '2', '3', '4', '5', '6', '7', '8'].map((label) => (
                    <div className='details-input' key={label}>
                      <button
                        type='button'
                        className={`details-btn ${
                          selectedBathrooms.toString() === label ? 'selected' : ''
                        }`}
                        onClick={() => {
                          if (label === 'Any') {
                ...
                <div className='ammenities-section'>
                  ...
                  <div className='ammenities-input'>
                    <input
                      ...
                      onChange={handleCheckboxChange}
                      checked={selectedAmmenties.includes('dedicated-workspace')}
                    />
                    <label htmlFor='dedicated-workspace'>Dedicated workspace</label>
                  </div>
                  <div className='ammenities-input'>
                    <input
                      type='checkbox'
